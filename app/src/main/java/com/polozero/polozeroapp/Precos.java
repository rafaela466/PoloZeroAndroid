    ...
    @Override
        public void onClick(View view) {
            ...
            switch(view.getId()){
                ...
                case R.id.btnSamsungPrice :  Intent browserIntent1 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://polozero.com/wp-content/uploads/2022/06/samsung_junho_2022.pdf"));
                    startActivity(browserIntent1); break;
                case R.id.btnDaikinPrice : Intent browserIntent2 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://polozero.com/wp-content/uploads/2022/08/daikin_tabelaV2_2022.pdf"));
                    startActivity(browserIntent2); break;
                case R.id.btnDaitsuPrice : Intent browserIntent3 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://polozero.com/wp-content/uploads/2022/03/DAITSU-2022.pdf"));
                ...
                case R.id.btnFujitsuPrice: Intent browserIntent5 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://polozero.com/wp-content/uploads/2022/03/fujitsu_marco_2022.pdf"));
                    startActivity(browserIntent5); break;
                case R.id.btnMitsubishiPrice: Intent browserIntent6 = new Intent(Intent.ACTION_VIEW,Uri.parse("https://polozero.com/wp-content/uploads/2022/04/mitsu_tabela_preco2022.pdf"));
                    startActivity(browserIntent6); break;
                case R.id.btnTestoPrice: Intent browserIntent8 = new Intent(Intent.ACTION_VIEW,Uri.parse("https://polozero.com/wp-content/uploads/2022/07/testo_tp_2022_V4.pdf"));
                    startActivity(browserIntent8); break;
                case R.id.btnHtwPrice:  Intent browserIntent9 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://polozero.com/wp-content/uploads/2022/06/HTW_junho.pdf"));
                ...
                case R.id.btnGaserveiPrice: Intent browserIntent12 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://polozero.com/wp-content/uploads/2022/03/gasservei2022.pdf"));
                ...
                case R.id.btnDanfossPrice: Intent browserIntent14 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://polozero.com/wp-content/uploads/2022/05/TabelaDanfoss2022.pdf"));
                    startActivity(browserIntent14); break;
                case R.id.btnToyotomiPrice: Intent browserIntent15 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://polozero.com/wp-content/uploads/2022/03/Tabela_TOYOTOMI_2.pdf"));
